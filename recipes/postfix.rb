...
node.set['postfix'] = Hash.new unless node['postfix']
node.set['postfix']['main'] = Hash.new unless node['postfix']['main']
node.set['postfix']['sasl'] = Hash.new unless node['postfix']['sasl']
